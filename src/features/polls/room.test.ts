...
describe("room manifest encoding", () => {
  it("round-trips a room through the URL hash contract", () => {
    const generated = createGeneratedRoom(4, "Test Room");
  ...
  it("round-trips an invite and validates room membership", () => {
    const generated = createGeneratedRoom(4, "Invite Room");
